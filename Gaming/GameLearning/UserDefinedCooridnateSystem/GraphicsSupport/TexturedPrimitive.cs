...
using UserDefinedCooridnateSystem.GraphicsSupport;
...
namespace BookExample
{
    ...
    public class TexturedPrimitive
    {
        ...
        public void Draw()
        {
            ...
            Rectangle desRect = Camera.ComputePixelRectangle(Position, Size);
            Game1.sSpriteBatch.Draw(mImage, desRect, Color.White);
        }
    }
}
