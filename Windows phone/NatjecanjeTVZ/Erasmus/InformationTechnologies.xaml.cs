...
namespace Erasmus
{
    public partial class InformationTechnologies : PhoneApplicationPage
    {
        public InformationTechnologies()
        {
            InitializeComponent();
        ...
        {
            ShellTile.Create(new Uri("/InformationTechnologies.xaml", UriKind.Relative), new StandardTileData()
            {
                BackgroundImage = new Uri("isostore:/Shared/ShellContent/image.png", UriKind.Absolute),
                Title = "Information Techonologies"
            });
        }
    }
}