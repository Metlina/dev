...
namespace MetroUiTest
{
    public class MetroUICSSBundleConfig
    {
        public static void RegisterBundles()
        {
            ...
            BundleTable.Bundles.Add(new ScriptBundle("~/bundles/metro-ui").Include(
                "~/Scripts/metro-ui/jquery.ui.widget.js").Include(
                "~/Scripts/metro-ui/metro.min.js"));

            BundleTable.Bundles.Add(new StyleBundle("~/Content/metro-ui/css").Include(
